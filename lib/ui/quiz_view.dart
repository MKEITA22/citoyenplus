                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => Quizquestions(
                              categorie: cat["title"],
                              questions: _getQuestionsPourCategorie(
                                cat["title"],
                              ),
                            ),
                          ),
...
List<Map<String, dynamic>> _getQuestionsPourCategorie(String categorie) {
  switch (categorie) {
    case "Citoyenneté":
      return [
        {
    ...
    },
    {
      ...
      "options": ["Observer", "Participer à la vie publique", "Critiquer", "Ignorer les lois"],
      "correct": 1,
    },
    {
      "question": "Quel document prouve la nationalité ivoirienne ?",
      "options": ["Le passeport", "La carte nationale d’identité", "Le permis de conduire", "L’acte de naissance"],
      "correct": 1,
    },
    {
    ...
    },
    {
      ...
      "options": ["L’unité", "Les richesses du pays", "Les régions", "Les partis politiques"],
      "correct": 1,
    },
    {
    ...
    },
    {
      ...
      "options": ["Régler les matchs", "Fixer les lois fondamentales", "Organiser les fêtes", "Choisir le président"],
      "correct": 1,
    },
    {
      "question": "Que favorise le respect des lois ?",
      "options": ["Le désordre", "La paix sociale", "La division", "Le chaos"],
      "correct": 1,
    },
    ...
    },
    {
      ...
      "options": ["On accélère fort", "On vérifie les rétroviseurs", "On klaxonne seulement", "On ferme les yeux"],
      "correct": 1,
    },
    {
    ...
    },
    {
      ...
      "options": ["Celui de droite", "Celui de gauche", "Celui qui klaxonne", "Celui qui roule vite"],
      "correct": 0,
    },
    {
      "question": "Quel document doit-on toujours avoir en voiture ?",
      "options": ["Carte grise", "Facture d’achat", "Passeport", "Bulletin de notes"],
      "correct": 0,
    },
        // . Ajouter les questions
      ];
    ...
    },
    {
      ...
      "options": ["Le foutou", "Le garba", "Le kédjénou", "L’attiéké-poisson"],
      "correct": 3,
    },
    {
      "question": "Quelle est la devise nationale ?",
      "options": ["Travail – Famille – Patrie", "Union – Discipline – Travail", "Paix – Unité – Progrès", "Force – Courage – Foi"],
      "correct": 2,
    },
    {
      "question": "Quel est le plus grand stade du pays ?",
      "options": ["Stade Houphouët-Boigny", "Stade de la Paix", "Stade Alassane Ouattara d’Ebimpé", "Stade Gagnoa"],
      "correct": 2,
    },
    {
    ...
    },
    {
      ...
      "options": ["La belle des lagunes", "La ville lumière", "La cité du cacao", "La capitale de l’Afrique de l’Ouest"],
      "correct": 0,
    },
    {
      "question": "Quel est l’hymne national de la Côte d’Ivoire ?",
      "options": ["L’Abidjanaise", "Paix et Unité", "L’Ivoirienne", "Notre Patrie"],
      "correct": 0,
    },
        // . Ajouter les questions
      ];
    ...
    case "Institutions":
      return [
        {
    "question": "Quelle est l’institution qui veille au respect de la Constitution en Côte d’Ivoire ?",
    "options": ["La CEI", "Le Conseil Constitutionnel", "Le Sénat", "Le Gouvernement"],
    "correct": 1,
  },
  {
    "question": "Quel est le rôle principal de l’Assemblée Nationale ?",
    "options": ["Faire les lois", "Contrôler les frontières", "Nommer le président", "Organiser les élections"],
    "correct": 0,
  },
  {
  ...
  },
  {
    ...
    "options": ["Le peuple", "Le Président de la République", "Le Sénat", "La CEI"],
    "correct": 1,
  },
  {
    "question": "Quelle institution organise les élections en Côte d’Ivoire ?",
    "options": ["CPI", "ONU", "CEI", "Conseil Constitutionnel"],
    "correct": 2,
  },
  {
    "question": "Quelle est la plus haute juridiction du pays ?",
    "options": ["Cour d’appel", "Cour suprême", "Tribunal de première instance", "Conseil d’État"],
    "correct": 1,
  },
  {
    "question": "Quel est le rôle de la Cour des comptes ?",
    "options": ["Contrôler les finances publiques", "Juger les citoyens", "Créer les lois", "Organiser les élections"],
    "correct": 0,
  },
  {
    "question": "Quel est le mandat du Président de la République ivoirienne ?",
  ...
  },
  {
    ...
    "options": ["Le Maire", "Le Gouverneur", "Le Préfet de région", "Le Député"],
    "correct": 2,
  },
        // . Ajouter les questions
      ];
    ...
    "options": ["Le droit à la santé", "Le droit à la vie", "Le droit au travail", "Le droit à l’éducation"],
    "correct": 1,
  },
  {
    "question": "Quel texte fondamental protège les droits humains en Côte d’Ivoire ?",
    "options": ["Le Code civil", "La Constitution", "Le Code du travail", "Le Code pénal"],
    "correct": 1,
  },
  {
    "question": "Qui veille à la protection des droits de l’Homme en Côte d’Ivoire ?",
  ...
  {
    "question": "Quel est le document international qui protège les droits humains ?",
    "options": [
  ...
  },
  {
    ...
    "options": ["Seulement aux enfants", "Tous les citoyens", "Les fonctionnaires", "Les étrangers uniquement"],
    "correct": 1,
  },
  {
  ...
  },
  {
    ...
    "options": ["Optionnels", "Universels et inaliénables", "Nationaux", "Héréditaires"],
    "correct": 1,
  },
  {
  ...
  {
    "question": "Quel groupe est le plus souvent protégé par les droits humains spécifiques ?",
    "options": [
  ...
  },
  {
    ...
    "options": ["Voter dans le calme", "Faire campagne dans la rue", "Refuser le scrutin", "Protester violemment"],
    "correct": 0,
  },
  {
    "question": "Le respect du drapeau national est un signe de :",
    "options": ["Civisme et patriotisme", "Désintérêt", "Rébellion", "Ignorance"],
    "correct": 0,
  },
  {
  ...
  },
  {
    ...
    "options": ["Le respect du temps", "Le désordre", "La paresse", "Le mépris"],
    "correct": 0,
  },
  {
    "question": "Pourquoi doit-on respecter les autorités ?",
    "options": ["Parce qu’elles représentent la loi", "Parce qu’on a peur", "Pour gagner de l’argent", "Par obligation"],
    "correct": 0,
  },
  {
    "question": "Quelle est une valeur fondamentale de la société ivoirienne ?",
    "options": ["La fraternité", "La tricherie", "Le mensonge", "L’indifférence"],
    "correct": 0,
  },
        // . Ajouter les questions
      ];
